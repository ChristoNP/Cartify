            ...
            <header className="bg-[#4AC419] text-white py-4 sm:py-6 shadow-[inset_5px_5px_10px_#3fa316,inset_-5px_-5px_10px_#55e51c]">
                <nav className="container mx-auto px-4 flex flex-wrap items-center justify-between">
                    ...
                    <div className="font-outfit flex items-center space-x-2 sm:space-x-4">
                        ...
                        <Link href="/login"
                            className="bg-[#4AC419] text-white px-3 py-1 sm:px-4 sm:py-2 rounded-full shadow-[3px_3px_6px_#3fa316,-3px_-3px_6px_#55e51c] hover:shadow-[inset_3px_3px_6px_#3fa316,inset_-3px_-3px_6px_#55e51c] transition-all duration-300 text-xs sm:text-sm font-medium"
                        >
                            Sign in
                        </Link>
                        <Link href="/register"
